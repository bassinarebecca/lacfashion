...
<div class="droite  card col ">
    <div class="card-header text-center font-weight-bold"> <i class="text-info fas fa-plus-circle"></i> Categorie</div>
    <div class="card-body">
        <form method="post" action="{{route('categorie.store')}}" id="tr_form" enctype="multipart/form-data" >
            @csrf
